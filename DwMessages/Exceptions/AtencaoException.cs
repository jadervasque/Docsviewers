...
{
    public class AtencaoException : Exception, IExceptions
    {
        ...
        public AtencaoException()
          : base(string.Empty)
        {
            Blank = true;
        }

        public AtencaoException(string mensagem)
          : base(mensagem)
        {
            Mensagem = mensagem;
        }

        public AtencaoException(string titulo, string mensagem)
        ...
        public AtencaoException(string titulo, string mensagem, Size tamanho)
          : base(string.Format("{0}{1}{1}{2}", titulo, "\r\n", mensagem))
        {
            Titulo = titulo;
            Mensagem = mensagem;
        ...
        /// 11: 800x600, 
        /// 12: 800x700</param>
        public AtencaoException(string titulo, string mensagem, int tamanho)
          : base(string.Format("{0}{1}{1}{2}", titulo, "\r\n", mensagem))
        {
            Titulo = titulo;
            Mensagem = mensagem;
